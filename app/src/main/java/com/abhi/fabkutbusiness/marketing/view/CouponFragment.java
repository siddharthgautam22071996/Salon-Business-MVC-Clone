...
public class CouponFragment extends Fragment implements RetrofitApi.ResponseListener {
...
//
    ...
    public void _onNext(Object obj) {
        ...
        if (responseCreatePromotion.getSTATUS().equalsIgnoreCase("200")){
            OffersListAdapter offersListAdapter = new OffersListAdapter(getActivity(),
                    responseCreatePromotion.getData(),((RunPromotion)getContext()).getViewStatus());
