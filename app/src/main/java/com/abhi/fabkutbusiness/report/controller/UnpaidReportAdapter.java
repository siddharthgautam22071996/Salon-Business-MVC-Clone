...
public class UnpaidReportAdapter extends ArrayAdapter<ResponseModelCustomerData> {
    Context context;
    ...
    public UnpaidReportAdapter(Context context, ArrayList<ResponseModelCustomerData> responseMyStockData) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)  {
        ...
        viewHolder.service.setText("Rs. "+responseModelAppointmentsData.getPrevious_balance() + " " );
        ...
        viewHolder.mob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:"+responseModelAppointmentsData.getContact_no()));
